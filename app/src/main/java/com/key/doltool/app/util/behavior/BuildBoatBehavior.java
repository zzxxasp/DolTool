package com.key.doltool.app.util.behavior;
 ...
 */
public class BuildBoatBehavior extends CoordinatorLayout.Behavior<View>{
    ...
    public BuildBoatBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
