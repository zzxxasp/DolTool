package com.key.doltool.view.flat;
...
import com.key.doltool.view.flat.util.Attributes;
import com.key.doltool.view.flat.util.FlatUI;
import com.key.doltool.view.flat.util.TouchEffectAnimator;
...
public class FlatButton extends Button implements Attributes.AttributeChangeListener {
    ...
    protected void onDraw(final Canvas canvas) {
        if (attributes.hasTouchEffect() && touchEffectAnimator != null)
            touchEffectAnimator.draw(canvas);
        super.onDraw(canvas);
    }
