package com.key.doltool.view.range;
...
public class RangeBar extends View {
    ...
    private static final int DEFAULT_THUMB_IMAGE_NORMAL = R.drawable.tag_off;
    private static final int DEFAULT_THUMB_IMAGE_PRESSED = R.drawable.tag_on;
